...
import lean_picture from "../assets/images/lean.jpg";
  ...
  return (
    <React.Fragment>
      ...
      <div className="container">
        ...
        <div className="row rower">
          ...
          <div className="col-sm-8 images">
            ...
            <img
              ...
              className="small-images"
            />
            <img src={messanger} alt="Messanger" className="small-images" />
          </div>
        </div>
        <div className="row rower">
          <div className="col-sm-12">
            <h3 className="heroshe-website">
              The Heroshe website has seen a geometric increase - up to a
              whopping 1348% progression rate - in the number of new visitors on
              the website. This percentage derives from the exponential jump
              from 2100 to 30,414 visitors between December 2019 & January 2020
              to February & March 2020.
            </h3>
          </div>

          <div className="col-sm-12 rower">
            <img
              src={plot}
              alt="plot image"
              className="rower"
        ...
        <div className="row rower">
          <div className="col-sm-6 visitor">
            <a>Visit Heroshe.com & start shopping on US online stores</a>
          </div>
